...
oficina_path <- "D:/Usuario/Desktop/ROBERTO_CEBALLOS/Maestría/SEMESTRE III/PROYECTO INTEGRADOR/"
...
# Exportar limpio
write.csv2(
  df_export_buffer,  # usa ; como separador (Excel en espa�ol lo abre directo)
  file.path(
    base_path,
    "beetle-habitat-prediction",
    "datos_presencia_gbif",
